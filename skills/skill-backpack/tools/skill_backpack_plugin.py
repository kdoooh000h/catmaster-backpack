...
def install_opencode_adapter(project_root: Path) -> tuple[str, str]:
    ...
    guidance_text = (OPENCODE_ADAPTER_ROOT / "AGENTS.md").read_text(encoding="utf-8")
    ...
    shutil.copy2(OPENCODE_ADAPTER_ROOT / "tools" / "tool_backpack.ts", tool_target)
